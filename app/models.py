...
class PublishRecord(Base):
    ...
    publication_state: Mapped[str | None] = mapped_column(String(80), nullable=True, index=True)
    privacy_status: Mapped[str | None] = mapped_column(String(40), nullable=True)
    final_render_sha256: Mapped[str | None] = mapped_column(String(64), nullable=True)
    metadata_sha256: Mapped[str | None] = mapped_column(String(64), nullable=True)
    thumbnail_manifest_sha256: Mapped[str | None] = mapped_column(String(64), nullable=True)
    disclosure_state: Mapped[str | None] = mapped_column(String(80), nullable=True)
    provider_upload_id: Mapped[str | None] = mapped_column(String(240), nullable=True)
    created_at: Mapped[datetime] = mapped_column(DateTime, default=datetime.utcnow)
...
class AuditEvent(Base):
    ...
    campaign_id: Mapped[int | None] = mapped_column(ForeignKey("campaigns.id"), nullable=True, index=True)
    workflow_id: Mapped[str | None] = mapped_column(String(240), nullable=True)
