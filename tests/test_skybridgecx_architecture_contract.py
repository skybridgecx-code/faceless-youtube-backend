...
def test_target_contract_identity_and_current_authority_boundary() -> None:
    ...
    assert CONTRACT["repository"] == {
        ...
        "required_base_sha": "de3ac86f7ccbdb38fc0989a65856c3aaf115c67b",
    }
...
def test_source_lock_provenance_is_historical_not_current_execution_base() -> None:
    provenance = CONTRACT["source_lock_provenance"]
    assert provenance == {
        "constrains_current_execution": False,
        "historical_source_lock_commit": "2fc39ca0f72081f8b340a514e644079def01e21b",
        "initial_derivation_base_sha": "76c49a2092a140f1d63c4d17b68ab5b34b26eef2",
        "reconciled_runtime_base_sha": "de3ac86f7ccbdb38fc0989a65856c3aaf115c67b",
    }
    assert CONTRACT["repository"]["required_base_sha"] == (
        "de3ac86f7ccbdb38fc0989a65856c3aaf115c67b"
    )
    assert CONTRACT["repository"]["required_base_sha"] != (
        provenance["initial_derivation_base_sha"]
    )
