...
def main(argv: Sequence[str] | None = None) -> int:
    ...
    if not args.execute:
        ...
        print("MANAGED_LAUNCHERS=youmo,youmo-build,youmo-audit,youmo-checkpoint,youmo-controller,youmo-doctor,youmo-resume,youmo-pilot,youmo-publish,youmo-promote-check")
